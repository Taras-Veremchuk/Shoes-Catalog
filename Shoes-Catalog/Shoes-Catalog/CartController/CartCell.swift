...
class CartCell: UICollectionViewCell {
    ...
    private  func setConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            sumPriceLabel.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -20)
        ])
        NSLayoutConstraint.activate([
        ...
        NSLayoutConstraint.activate([
            ...
            deleteBtn.rightAnchor.constraint(equalTo: rightAnchor, constant: -10),
            deleteBtn.widthAnchor.constraint(equalToConstant: 30),
            deleteBtn.heightAnchor.constraint(equalToConstant: 30)
        ])
        NSLayoutConstraint.activate([
            titleLabel.leftAnchor.constraint(equalTo: shoesImageView.rightAnchor, constant: 10),
            titleLabel.topAnchor.constraint(equalTo: topAnchor, constant: 10),
            titleLabel.rightAnchor.constraint(equalTo: rightAnchor, constant: 10)
        ])
        NSLayoutConstraint.activate([
            priceLabel.leftAnchor.constraint(equalTo: shoesImageView.rightAnchor, constant: 10),
