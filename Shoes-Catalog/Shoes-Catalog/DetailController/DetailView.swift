...
class DetailView: UIView {
    let addToCartBtn = UIButton(
        title: "Add To Bin", bgColor: UIColor(named: "btnColor") ?? .blue,
    ...
    private func setupCollectionView() {
        ...
        self.sizesCollectionView = UICollectionView(
        ...
        sizesCollectionView.register(
            SizeCell.self, forCellWithReuseIdentifier: SizeCell.reusedID)
        sizesCollectionView.contentInset = .init(
    ...
    private func setConstraints() {
        let stack = UIStackView(
            views: [
                imageView, titleLabel, priceLabel, sizesCollectionView,
                addToCartBtn,
            ], axis: .vertical, spacing: 12, aligment: .fill)
